...
![flux-simple-f8-diagram-with-client-action-1300w.png](https://i.loli.net/2020/12/04/YtNOsvzm7VlKy2W.png)
...
![ff33122943c99967d5809725e10b2f7e_r.png](https://i.loli.net/2020/12/04/gDAkW5NpmQfSt6H.png)

MVC 是双向数据流架构，我们在前面提到过双向数据流的缺陷：导致数据的级联更新，这会使调试变得非常困难，因为有许多种情况可以改变需要调试的数据，判断出问题的根源需要很多时间。

相比之下，Flux 会使结构简单得多：

![5b3b3765741c4735792e9824be265835_720w.png](https://i.loli.net/2020/12/04/14qFbTfB7w8rzcQ.png)
...
![redux-data-flow.png](https://i.loli.net/2020/12/04/8NW5V4hm2GaZFRy.png)
...
![1607246729_1_.png](https://i.loli.net/2020/12/06/nSClwXVa9RpPJQy.png)
...
![6.png](https://i.loli.net/2020/12/06/S6OuxJyVLMWtl8z.png)
...
![1607258686_1_.png](https://i.loli.net/2020/12/06/aH1LsmixO3RCGb5.png)
...
![1607305228_1_.png](https://i.loli.net/2020/12/07/i5DUfEx7BFpcnWM.png)
...
![PPrerEAKbIoDZYr.png](https://i.loli.net/2020/12/07/4Uf8u5GSIMKvl2y.png)
